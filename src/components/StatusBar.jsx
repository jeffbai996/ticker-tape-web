...
function RollingClock() {
  ...
  return (
    <button
      ...
      data-status-clock
      class="h-5 group ml-1 flex cursor-pointer items-center gap-1 whitespace-nowrap font-anth px-1.5 py-0 rounded border border-transparent transition-colors duration-200 hover:border-line-2 hover:bg-white/[0.045] focus-visible:border-line-2 focus-visible:bg-white/[0.045] focus-visible:outline-none"
    >
