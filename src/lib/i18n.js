...
const STRINGS = {
  ...
  'watchlists.empty_body': {
    ...
    zh: '为财报、交易机会、板块，或刚传染进来的任何市场毛病建立专用列表。',
  },
  'demo.timeline_note': {
...
const LABELS = {
  // Nav
  Dashboard: '仪表盘', Watchlists: '自选列表', Markets: '市场', Research: '研究', Portfolio: '持仓',
  ...
  'Create watchlist': '创建自选列表', 'Watchlist name': '自选列表名称',
  PRIMARY: '主要', Rename: '重命名', Delete: '删除', Save: '保存',
  'Open dashboard →': '打开仪表盘 →', ticker: '只股票', tickers: '只股票',
  ...
  'empty watchlist — add the first ticker below': '自选列表为空 — 在下方添加第一只股票',
  'shared across Briefing, Wire, AI, and the tape': '在晨报、快讯、AI 和滚动行情中共享',
  'independent dashboard view': '独立仪表盘视图',
