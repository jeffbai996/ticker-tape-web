...
const LABELS = {
  ...
  Performance: '净值', 'since last': '较上次', Ledger: '账本', line: '行', Events: '分红财报', Held: '持有', 'Next results': '下次财报', 'Ex-dividend': '除息日', 'Last dividend': '最近分红', 'Est. income': '预计收入', 'Upcoming 14 days': '未来14天', 'No dates yet': '暂无日期', 'per share': '每股', Yield: '股息率', 'Nothing scheduled in the next two weeks.': '未来两周没有安排。', 'paid': '已派', 'record': '登记日',
