...
const STRINGS = {
  ...
  'wire.live_transcript': { en: 'live transcript', zh: '实时记录' },
  'wire.call_transcript': { en: 'call transcript', zh: '电话会议记录' },
  'wire.segment_count': { en: '{n} segments', zh: '{n} 段' },
...
const LABELS = {
  ...
  // Portfolio (demo)
  Account: '账户', Sizing: '仓位计算', Carry: '融资成本', Cockpit: '风险面板', Risk: '风险',
  ...
  'Daily change': '日涨跌', 'Daily range': '日振幅', Off: '关闭', Visual: '图形', Graph: '图表',
  ...
  'alert now': '当前', 'symbol chips': '股票代码', 'A/D': '涨 / 跌', 'ext A/D': '盘外涨 / 跌', 'Mov >2%': '异动 >2%', 'Flt <1%': '平盘 <1%',
  ...
  'Day range': '个股涨跌幅', 'Open P&L': '浮动盈亏', Open: '浮动', 'Cost basis': '成本合计', 'On cost': '按成本',
