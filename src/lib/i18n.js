...
const LABELS = {
  ...
  Performance: '净值', 'since last': '较上次', Ledger: '账本', line: '行', Events: '分红财报', Today: '今天', Yesterday: '昨天', 'Open original': '打开原文', Close: '关闭', Reading: '阅读中', 'Pick a story to read it here.': '点选一条新闻在此阅读。', 'Could not load the story — open the original instead.': '无法加载正文 — 请打开原文。', 'cloud offline': '云端离线', 'Search news': '搜索新闻', 'Show more': '显示更多', 'No matching headlines.': '没有匹配的新闻。', Held: '持有', 'Next results': '下次财报', 'Ex-dividend': '除息日', 'Last dividend': '最近分红', 'Est. income': '预计收入', 'Upcoming 14 days': '未来14天', 'No dates yet': '暂无日期', 'per share': '每股', Yield: '股息率', 'Nothing scheduled in the next two weeks.': '未来两周没有安排。', 'paid': '已派', 'record': '登记日',
