...
export async function fetchEvents(base, {
  sinceId = 0, limit = 100, newest = false, types = '',
} = {}) {
  const typeParam = String(types || '').trim()
  const resp = await fetch(
    `${base}/api/events?since_id=${sinceId}&limit=${limit}${newest ? '&newest=1' : ''}${typeParam ? `&types=${encodeURIComponent(typeParam)}` : ''}`)
...
const DEMO_FEED = [
  ...
  { type: 'earnings_release', symbols: ['NKE'], mins: 368,
    headline: 'NKE Q1 EPS $0.71 vs $0.64 est · North America inventory -9% y/y',
    zh: 'NKE 第一季度 EPS 0.71 美元，预期 0.64 美元 · 北美库存同比 -9%' },
  { type: 'earnings_release', symbols: ['ADBE'], mins: 381,
    headline: 'ADBE Q3 EPS $5.18 vs $4.96 est · digital media ARR above guide',
    zh: 'ADBE 第三季度 EPS 5.18 美元，预期 4.96 美元 · 数字媒体 ARR 高于指引' },
  { type: 'earnings_release', symbols: ['CRM'], mins: 395,
    headline: 'CRM Q2 revenue $10.2B vs $10.1B est · operating margin raised',
    zh: 'CRM 第二季度营收 102 亿美元，预期 101 亿美元 · 上调经营利润率指引' },
  { type: 'earnings_release', symbols: ['HD'], mins: 410,
    headline: 'HD Q2 EPS $4.81 vs $4.70 est · pro demand offsets softer DIY traffic',
    zh: 'HD 第二季度 EPS 4.81 美元，预期 4.70 美元 · 专业客户需求抵消 DIY 客流疲软' },
  { type: 'earnings_release', symbols: ['PEP'], mins: 426,
    headline: 'PEP Q3 organic sales +4.2% vs +3.6% est · full-year outlook held',
    zh: 'PEP 第三季度有机销售 +4.2%，预期 +3.6% · 维持全年展望' },
  { type: 'earnings_release', symbols: ['AMAT'], mins: 443,
    headline: 'AMAT Q4 EPS $2.41 vs $2.32 est · foundry-logic systems lead orders',
    zh: 'AMAT 第四季度 EPS 2.41 美元，预期 2.32 美元 · 晶圆代工与逻辑系统领跑订单' },
  { type: 'earnings_release', symbols: ['CSCO'], mins: 461,
    headline: 'CSCO Q1 EPS $0.94 vs $0.91 est · product orders return to growth',
    zh: 'CSCO 第一季度 EPS 0.94 美元，预期 0.91 美元 · 产品订单恢复增长' },
]
